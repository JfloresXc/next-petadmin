          ...
          <div className="flex flex-wrap items-center md:justify-between justify-center">
            <div className="w-full md:w-4/12 px-4">
              ...
              Copyright © {new Date().getFullYear()} Orejitas y colitas by{' '}
                <a
                  ...
                  target='_blank'
                  className="text-blueGray-500 hover:text-blueGray-800" rel="noreferrer"
                >
                  Jfloresxc
                </a>
                .
            ...
            <div className="w-full md:w-8/12 px-4">
              <ul className="flex flex-wrap list-none md:justify-end  justify-center">
                <li>
                  <a
                    href="https://jfloresxc.github.io-admin"
                    target='_blank'
                    className="text-blueGray-600 hover:text-blueGray-800 text-sm font-semibold block py-1 px-3" rel="noreferrer"
                  >
                    Jfloresxc
                  </a>
                </li>
